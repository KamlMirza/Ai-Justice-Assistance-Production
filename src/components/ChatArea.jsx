...
export default function ChatArea({ 
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // Mark stage 1 as complete after first response (only if in-domain)
      if (currentStage === 1 && !progress.caseProblem && !isOutOfDomain) {
        setProgress(prev => ({ ...prev, caseProblem: true }))
      }
  ...
  return (
    <div className="chat-area">
      ...
      <div className="messages-container">
        ...
        {!loading && currentStage === 2 && caseData.courts && caseData.courts.length > 0 && (
          <div className="stage-action">
        ...
        {!loading && currentStage === 3 && caseData.lawyers && caseData.lawyers.length > 0 && (
          <div className="stage-action">
